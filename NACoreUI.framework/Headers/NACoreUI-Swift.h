...
#ifndef NACOREUI_SWIFT_H
#define NACOREUI_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="NACoreUI",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC8NACoreUI18CollectionViewCell")
...
SWIFT_CLASS("_TtC8NACoreUI24CollectionViewController")
...
SWIFT_CLASS("_TtC8NACoreUI20CollectionViewSource")
...
@interface CollectionViewSource (SWIFT_EXTENSION(NACoreUI)) <UICollectionViewDelegate>
...
@interface CollectionViewSource (SWIFT_EXTENSION(NACoreUI)) <UICollectionViewDelegateFlowLayout>
...
@interface CollectionViewSource (SWIFT_EXTENSION(NACoreUI)) <UICollectionViewDataSource>
...
@interface DraggableView (SWIFT_EXTENSION(NACoreUI)) <UIGestureRecognizerDelegate>
...
SWIFT_PROTOCOL("_TtP8NACoreUI21DraggableViewDelegate_")
@protocol DraggableViewDelegate
@optional
- (void)panGestureDidBegin:(UIPanGestureRecognizer * _Nonnull)panGesture originalCenter:(CGPoint)originalCenter;
- (void)panGestureDidChange:(UIPanGestureRecognizer * _Nonnull)panGesture originalCenter:(CGPoint)originalCenter translation:(CGPoint)translation velocityInView:(CGPoint)velocityInView;
- (void)panGestureDidEnd:(UIPanGestureRecognizer * _Nonnull)panGesture originalCenter:(CGPoint)originalCenter translation:(CGPoint)translation velocityInView:(CGPoint)velocityInView;
- (void)panGestureStateToOriginal:(UIPanGestureRecognizer * _Nonnull)panGesture originalCenter:(CGPoint)originalCenter translation:(CGPoint)translation velocityInView:(CGPoint)velocityInView;
- (BOOL)panGestureShouldBegin:(UIPanGestureRecognizer * _Nonnull)panGesture SWIFT_WARN_UNUSED_RESULT;
@end

@class UIColor;

IB_DESIGNABLE
SWIFT_CLASS("_TtC8NACoreUI12GradientView")
...
@property (nonatomic, copy) IBInspectable NSString * _Nonnull direction;
...
IB_DESIGNABLE
SWIFT_CLASS("_TtC8NACoreUI21KMPlaceholderTextView")
...
@property (nonatomic, copy) IBInspectable NSString * _Nullable fontFormat;
@end
