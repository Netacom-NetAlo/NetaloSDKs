...
IB_DESIGNABLE
SWIFT_CLASS("_TtC19NetAloCoreComponent12ChatTextView")
...
@interface ChatTextView (SWIFT_EXTENSION(NetAloCoreComponent)) <UITextViewDelegate>
...
SWIFT_CLASS("_TtC19NetAloCoreComponent8InputBar")
@interface InputBar : NABaseView
@property (nonatomic, weak) IBOutlet ChatTextView * _Null_unspecified tvMain;
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified btnEmoji;
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end
...
@interface NABaseVC : UIViewController <UIGestureRecognizerDelegate>
- (void)viewDidLoad;
- (void)loadView;
...
SWIFT_CLASS("_TtC19NetAloCoreComponent20NavigationChatHeader")
@interface NavigationChatHeader : NABaseView
@property (nonatomic, weak) IBOutlet NavigationHeaderView * _Null_unspecified vListPinHeader;
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC19NetAloCoreComponent14PinMessageView")
@interface PinMessageView : NABaseView
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end
