...
#ifndef NETALOFULL_SWIFT_H
#define NETALOFULL_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="NetAloFull",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC10NetAloFull17NetAloFullManager")
@interface NetAloFullManager : NSObject
...
@interface NetAloFullManager (SWIFT_EXTENSION(NetAloFull)) <UNUserNotificationCenterDelegate>
...
@interface NetAloFullManager (SWIFT_EXTENSION(NetAloFull)) <UIApplicationDelegate>
...
@interface NetAloFullManager (SWIFT_EXTENSION(NetAloFull))
- (void)socketConnect;
...
SWIFT_PROTOCOL("_TtP10NetAloFull10NetAloUser_")
@protocol NetAloUser
...
SWIFT_CLASS("_TtC10NetAloFull16NetAloUserHolder")
@interface NetAloUserHolder : NSObject <NetAloUser>
